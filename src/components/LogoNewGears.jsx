  ...
  >
    ...
    <defs>
      <linearGradient id="paint0_linear_302_578" x1="548.556" y1="535.528" x2="1568.11" y2="544.977" gradientUnits="userSpaceOnUse">
        <stop stopColor="var(--ng-logo-start, #6293E9)"/>
        <stop offset="0.315399" stopColor="var(--ng-logo-mid, #5D58D3)"/>
        <stop offset="0.75" stopColor="var(--ng-logo-deep, #820AAF)"/>
        <stop offset="1" stopColor="var(--ng-logo-end, #D01BF1)"/>
      </linearGradient>
